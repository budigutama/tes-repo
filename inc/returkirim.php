<div class="center_title_bar">Informasi Pengiriman Retur</div>
<?php
$qinvo =mysql_query("SELECT * FROM retur WHERE session_id ='".session_id()."'ORDER BY id_retur DESC LIMIT 1");
...
<div class="alamat">   
   <table width="100%" cellspacing="0" cellpadding="2" align="center">
      ...
      <tbody>
 <?php
    $qcart = mysql_query("SELECT * FROM detail_retur a, detail_pembelian b, produk c, detailproduk d
                          WHERE a.id_detailproduk = b.id_detailproduk
						  AND a.id_detailproduk = d.id_detailproduk
						  AND b.id_detailproduk = d.id_detailproduk
						  AND a.idpembelian = b.idpembelian						  
                          AND d.id_produk = c.id_produk
                          AND a.id_retur = '$idr'") or die(mysql_error());
    $i = 0;
    $subtotal = 0;
